...
class MessagePanel extends React.Component {
    constructor(props) {
        ...
        if (this.props.app.state.currentUser.joined_groups.length > 0) {
            defaultGroup = this.props.app.state.currentUser.joined_groups[0].name;
        } else {
            defaultGroup = "";
        }
    ...
    render() {
        ...
        if (this.props.groups) {
            ...
            groups = this.props.app.state.currentUser.joined_groups.concat(this.props.app.state.currentUser.owned_groups);
        }
