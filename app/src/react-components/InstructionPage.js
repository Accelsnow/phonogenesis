    ...
    render() {
        return <ThemeProvider theme={theme}>
            ...
            <div className="main-area">
                ...
                <h1>Phonogenesis instructions</h1>
                ...
                There are three <strong>rule types</strong> based on how the rule affects phonemic contrasts in
                ...
                whether it comes from an underlying voiceless or voiced stop.

                An <strong>alternating</strong> rule in a rule that collapses no phonemic contrasts at all. For
                ...
                [b d ɡ] can only come from underlying /p t k/.

                A <strong>mixed</strong> rule is a rule that is neutralizing for some phonemes and alternating
                ...
                <strong>Size</strong> is the total amount of initial data you want to generate. There is an
                option to get more data afterward, up to 50 words total.

                You can also select whether or not to <strong>shuffle</strong> the data randomly and whether or
                ...
                When you click the <strong>generate data</strong> button, a data set following these settings
                ...
                allophones of the targeted phonemes.

                The generated data contains a mixture of words, some in which the rule has applied, some in
                which the environment and/or target are a close match for the rule but not close enough to
                trigger the rule, and some which are filler that are not relevant to the rule.

                <h2>Hints for solving the problem</h2>

                Once the data set is displayed, you can then click buttons to toggle various options to show and
                ...
                rules and data should always be compatible, never contradictory.

                If you need more data to solve the problem, you can generate more with the <strong>more
                ...
                a warning message that no more data can be generated.
