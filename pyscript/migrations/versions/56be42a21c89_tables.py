...
Revision ID: 56be42a21c89
Revises: 
Create Date: 2020-09-22 13:41:45.570004
...
def upgrade():
    ...
    op.create_index(op.f('ix_tablename_timestamp'), 'tablename', ['timestamp'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_tablename_timestamp'), table_name='tablename')
